...
use crate::tui::renderer::{Screen, EFI_GREEN, EFI_LIGHTGREEN, EFI_WHITE, EFI_BLACK};
...
impl DebugOverlay {
    ...
    pub fn render(&self, screen: &mut Screen) {
        ...
        let color = if current_kb > 1024 { EFI_WHITE } else { EFI_LIGHTGREEN };
        ...
        let leak_color = if stats.leak_count() > 10 { EFI_WHITE } else { EFI_LIGHTGREEN };
        ...
        screen.put_str_at(x, y + 8, " [D] Toggle Debug Overlay    ", EFI_GREEN, EFI_BLACK);
    }
